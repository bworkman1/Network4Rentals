...
{ 
    ...
    public $api_login_ids = '';			// API Login ID
    public $api_transaction_keys = '';	// API Transaction Key
    public $api_url = 'https://secure.authorize.net/gateway/transact.dll';				// Where we postin' to?
