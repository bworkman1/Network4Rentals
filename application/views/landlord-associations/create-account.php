					...
					<?php echo form_open('landlord-associations/create-account', array('id'=>'createAccount')); ?>
						<fieldset>
							...
							<div class="form-group has-feedback row">
								...
								<div class="col-lg-7">
									<input type="text"  value="<?php echo set_value('username'); ?>" class="form-control" name="username" id="username" maxlength="20" required placeholder="6 characters or more - no spaces or special characters">
									<span class="fa username text-danger fa-asterisk form-control-feedback" aria-hidden="true"></span>
									<span id="username-error" class="sr-only"></span>
								</div>
							</div>	
							...
							<hr>
							<h3 class="text-center"><i class="fa fa-building text-primary"></i> Association Details</h3>
							<div class="form-group has-feedback row">
								<label class="col-lg-3 control-label" for="title">Assoc. Title:</label>
								<div class="col-lg-7">
									<input type="text" value="<?php echo set_value('title'); ?>" class="form-control" name="title" id="title" maxlength="100" required>
							...
							<div class="form-group has-feedback row">
								<label class="col-lg-3 control-label" for="name">Contact Name:</label>
								<div class="col-lg-7">
									<input type="text" class="form-control" value="<?php echo set_value('name'); ?>" name="name" placeholder="First and last name" id="name" maxlength="50" required>
							...
							<div class="form-group has-feedback row">
								...
								<div class="col-lg-7">
									<input type="text" value="<?php echo "(".substr(set_value('phone'), 0, 3).") ".substr(set_value('phone'), 3, 3)."-".substr(set_value('phone'),6); ?>" class="form-control phone" id="phone" name="phone" required>
							...
							<div class="form-group has-feedback row">
								...
								<div class="col-lg-7">
									<input type="text" value="<?php echo set_value('address'); ?>" name="address" class="form-control" id="address" maxlength="50" required>
							...
							<div class="form-group has-feedback row">
								...
								<div class="col-lg-7">
									<input type="text" value="<?php echo set_value('city'); ?>" class="form-control" name="city" id="city" maxlength="30" required>
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group has-feedback row">
										<label class="col-lg-6 control-label" for="state">State:</label>
										<div class="col-lg-6">
											<?php
							...
							<hr>
							<h3 class="text-center"><i class="fa fa-map-marker text-primary"></i> Service Areas</h3>
							<p class="text-center">Enter zip code and hit your tab button to enter zip</p>
							
							<div class="form-group has-feedback row">
								<label class="col-lg-3 control-label" for="service_zips">Service Areas:</label>
								<div class="col-lg-7">
									<input type="text"  value="<?php echo set_value('service_zips'); ?>"class="form-control numbersOnly" id="service_zips" name="service_zips" required>
							...
							<div class="form-group has-feedback row">
								...
								<div class="col-lg-7">
									<input type="text" value="<?php echo set_value('cc_number'); ?>" name="cc_number" class="form-control c_card removeRequired" id="cc_number" maxlength="50" required>
									<span class="fa text-danger fa-asterisk form-control-feedback" aria-hidden="true"></span>
							...
							<div class="form-group has-feedback row">
								<label class="col-md-5 col-md-offset-3 control-label" for="terms">I agree To The Terms Of Service:</label>
								<div class="col-md-1">
