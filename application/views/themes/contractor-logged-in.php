					...
					<nav class="navbar navbar-default" role="navigation">
						...
						<div class="collapse navbar-collapse">
							<ul class="nav nav-stacked">
								<li><a href="https://www.network4rentals.com"><i class="fa fa-home fa-fw"></i> Home</a></li>
								<li><a href="<?php echo base_url(); ?>contractors/home"><i class="fa fa-file fa-fw"></i> Main Page</a></li>
								<li><a href="<?php echo base_url(); ?>contractors/my-account"><i class="fa fa-gears fa-fw"></i> My Account</a></li>
								<li><a href="<?php echo base_url(); ?>contractors/my-zips"><i class="fa fa-map-marker fa-fw"></i> My Zips</a></li>
								<li><a href="<?php echo base_url(); ?>contractors/stats"><i class="fa fa-bar-chart fa-fw"></i> Stats</a></li>
								<li><a href="<?php echo base_url(); ?>contractors/public-page-settings"><i class="fa fa-laptop fa-fw"></i> My Web Page</a></li>
								<li><a href="<?php echo base_url(); ?>contractors/service-requests"><i class="fa fa-wrench fa-fw"></i> Service Request</a></li>
								<li><a href="<?php echo base_url(); ?>contractors/resources"><i class="fa fa-exclamation fa-fw"></i> Resources</a></li>
								...
								<li><a href="<?php echo base_url(); ?>contractors/logout"><i class="fa fa-lock fa-fw"></i> Logout</a></li>
							</ul>
						</div><!-- /.navbar-collapse -->
					</nav>
				</div>
		...
		<footer>
			<div class='container'>
				<div class="row text-center">
					...
					<div class="col-sm-6">
						Developed &amp; Hosted By <a href="http://emf-websolutions.com" target="_blank">EMF Web Solutions</a>
					</div>
				</div>
			</div>
		</footer>
