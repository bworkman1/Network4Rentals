<?php
	...
	if(empty($settings->image)) {
		$settings->image = 'http://placehold.it/450x450';
	} else {
...
<div class="row">
	<div class="col-sm-8">
		<h2><i class="fa fa-link text-success"></i></i> Public Page Settings</h2>
	</div>
	<div class="col-sm-4 text-right">
		...
		<?php
			if($settings->active == 'y') {
				if($link == true) {
					echo '<a href="http://n4r.rentals/'.strtolower(str_replace(' ', '-', $settings->unique_name)).'" class="btn btn-success btn-xs" target="_blank">
...
<hr>
<?php echo form_open_multipart('contractors/public-page-settings'); ?>
<div class="row">
	<div class="col-sm-5">
		<br>
...
<div clas="row">
	<div class="col-sm-3">
		...
		<?php
			if(!empty($settings->background)) {
				echo '<a href="'.base_url().'contractors/delete-public-image/'.$settings->id.'" class="btn btn-danger btn-block btn-sm"><i class="fa fa-image"></i> Change Image</a>';
			} else {
