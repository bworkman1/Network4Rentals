...
<div class="alert alert-info">
	<b>This is the create account not present form!</b>
</div>
...
<?php echo form_open('contractors/create-account-not-present', array('id'=>'createAccountForm')); ?>
	...
	<div class="col-xs-12">
		<div class="col-md-12 well text-left">
			...
			<div class="text-right">
				<button class="btn btn-success btn-sm stepProceed2 steper" onclick="javascript:resetActive(event, 25, 'step-2');"> Next Step <i class="fa fa-mail-forward"></i></button>
			</div>
		</div>
	</div>
</div>
<div class="row setup-content step hiddenStepInfo" id="step-2">
	<div class="col-xs-12">
		<div class="col-md-12 well text-left">
			...
			<div class="pull-left">
				<button class="btn btn-success btn-sm stepProceed2 steper" onclick="javascript: resetActive(event, 0, 'step-1');"> <i class="fa fa-mail-reply"></i> Back</button>
			</div>
			<div class="text-right">
				<button class="btn btn-success btn-sm stepProceed3 steper">Next Step <i class="fa fa-mail-forward"></i></button>
			</div>
		</div>
	</div>
</div>
<div class="row setup-content step hiddenStepInfo" id="step-3">
	<div class="col-xs-12">
		<div class="col-md-12 well text-left">
			...
			<div class="row">
				<div class="col-sm-6">
					<label class="control-label" for="user_name"><span class="text-danger">*</span> User Name:</label>  
					<input id="user" name="user" autocomplete="off" type="text" class="form-control input-md" required="" maxlength="20" tabindex="16" value="<?php echo set_value('user'); ?>">
					<div class="user-error-text"></div>
					...
					<div class="row" style="visibility: hidden;">
						<div class="col-xs-1">
							<input type="checkbox" id="termsService"  required="required" value="n" name="terms" tabindex="19" checked>
						</div>
					</div>
			...
			<div class="pull-left">
				<button class="btn btn-success btn-sm" onclick="javascript: resetActive(event, 25, 'step-2');"><i class="fa fa-mail-reply"></i> Back</button>
			</div>
			<div class="pull-right">
				<button class="btn btn-success btn-sm stepProceed4 steper" onclick="javascript:resetActive(event, 100, 'step-5');"> Next Step <i class="fa fa-mail-forward"></i></button>
			</div>
		</div>
	</div>
</div>
<div class="row setup-content step hiddenStepInfo" id="step-4">
	<div class="col-xs-12">
		<div class="col-md-12 well text-left">
			...
			<div class="pull-left">
				<button class="btn btn-success btn-sm" onclick="javascript: resetActive(event, 50, 'step-3');"><i class="fa fa-mail-reply"></i> Back</button>
			</div>
			<div class="pull-right">
				<button class="btn btn-success btn-sm stepProceed5 steper"> Next Step <i class="fa fa-mail-forward"></i></button>
			</div>
		</div>
	</div>
</div>
								...
								if(!empty($zips)) {
									for($i=0;$i<count($zips);$i++) {
										echo '<div class="'.$zips[$i].'-'.$service[$i].'" data-dup="'.$zips[$i].'-'.$service[$i].'">';
											echo '<div class="row">';
												echo '<div class="col-sm-3">'.$zips[$i].'</div>';
												echo '<div class="col-sm-6">'.$services_array[$service[$i]].'</div>';
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="well step2details">
						<legend><i class="fa fa-user"></i> Personal Info</legend>
						<div class="fill-out">
							<div class="row">
								<div class="col-sm-6">
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="well step3details">
						...
						<br>
						<button class="btn btn-success btn-sm stepProceed4 steper" onclick="javascript: resetActive(event, 75, 'step-3');"> <i class="fa fa-pencil"></i> Edit</button>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="well step4details">
						...
						<br>
						<button class="btn btn-success btn-sm stepProceed3 steper" onclick="javascript: resetActive(event, 50, 'step-4');"> <i class="fa fa-pencil"></i> Edit</button>
					</div>
				</div>
			</div>
