<h3><i class="fa fa-gears text-success"></i> My Account</h3>
<hr>
<?php
...
<div class="tab-content">
	<div class="tab-pane fade in active" id="profile">
		<h4><i class="fa fa-user text-success"></i> Profile</h4>
		<hr>
		<?php echo form_open('contractors/update-personal-info'); ?>
	...
	<div class="tab-pane fade" id="password">
		<h4><i class="fa fa-key text-success"></i> Change Password</h4>
		<hr>
		<?php echo form_open('contractors/update-password'); ?>
			<div class="row">
				<div class="col-sm-6">
			...
			<br>
			<button type="submit" class="btn btn-success btn-sm changePass"><i class="fa fa-save"></i> Save</button>
			<br>
		<?php echo form_close(); ?>
	</div>
	<div class="tab-pane fade" id="updates">
		<h4><i class="fa fa-code-fork text-success"></i> Recent Updates</h4>
		<hr>
		<?php
			if(!empty($updates)) {
	...
	<div class="tab-pane fade" id="subscription">
		<div class="row">
			<div class="col-sm-6">
				<h4><i class="fa fa-calendar text-success"></i> My Subscription</h4>
			</div>
			<div class="col-sm-6 text-right">
				<?php if($subscription==false) { ?>
					<a href="<?php echo base_url(); ?>contractors/add-zip-codes" style="margin-top: 5px" class="btn btn-success btn-sm"><i class="fa fa-map-marker"></i> Add Zips/Services</a>
				<?php } ?>
			</div>
		</div>
		<hr>
		<?php
			if($subscription==false) {
				...
				echo '<div class="well">';
					echo '<i class="fa fa-newspaper-o fa-fw text-success"></i> Currently You Subscribe To <b>'.count($subscription).'</b> Zip Codes<br>';
					echo '<i class="fa fa-dollar fa-fw text-success"></i> For A Total Of <b>$'.$payment->amount.'</b> Every <b>'.$payment->payment_frequency.'</b> Month(s)<br>';
					...
					echo '<i class="fa fa-calendar fa-fw text-success"></i> Next Billing Date: <b>'.date('m-d-Y', $next_due_date).'</b><br>';
					echo '<i class="fa fa-credit-card fa-fw text-success"></i> Credit Card: <b>****-****-****-'.$payment->last_4.'</b> <small> | Expires On </small>'.date('m-Y', strtotime($payment->expires));
				...
				echo '</div>';
				echo '<h4><i class="fa fa-bars text-success"></i> The Break Down</h4>';
				echo '<hr>';
				...
				foreach($subscription as $key => $val) {
					echo '<div class="row">';
						echo '<div class="col-sm-1">';
							echo $val->zip_purchased;
						echo '</div>';
						echo '<div class="col-sm-4">';
							echo $services_array[$val->service_purchased];
						echo '</div>';
						echo '<div class="col-sm-3">';
							echo '$'.$val->price.' <small>Per Month</small>';
						echo '</div>';
						echo '<div class="col-sm-2">';
							echo date('m-d-Y', strtotime($payment->payment_date));
						echo '</div>';
						echo '<div class="col-sm-2">';
							echo '<a href="'.base_url().'contractors/edit-post/'.$val->id.'" class="btn btn-block btn-success btn-sm">View Post</a>';
						echo '</div>';
					echo '</div>';
					echo '<br>';
				}
				echo '<hr>';
				echo '<br>';
				echo '<a href="#billing_info" role="tab" data-toggle="tab" class="btn btn-success btn-sm"><i class="fa fa-credit-card"></i> Edit Billing Info</a>';
			}
		?>	
		
	</div>
	<div class="tab-pane fade" id="billing_info">
		<?php echo form_open('contractors/my-account'); ?>
		<div class="row">
			<div class="col-sm-6">
				<h4><i class="fa fa-credit-card text-success"></i> Billing Info</h4>
			</div>
			<div class="col-sm-6 text-right">
				<br>
				<?php 
		...
		<div class="row">
			<div class="col-sm-6">
				<div class="well updateCreditCardData">
					<?php echo form_open('contractors/my_account'); ?>
					...
					<br>
					<button type="submit" class="btn btn-success btn-sm updatePayment"><i class="fa fa-update"></i> Update</button>
					<?php echo form_close(); ?>
				</div>
			</div>
			<div class="col-sm-6">
