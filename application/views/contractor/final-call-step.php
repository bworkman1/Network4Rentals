<div class="row">
	<div class="col-sm-6">
		<h2><i class="fa fa-paw text-success"></i> Final Step</h2>
	</div>
	...
	<div class="col-sm-6 removeOnSuccess">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-sm-6">
						<button id="resendEmail" class="btn btn-success btn-sm btn-block">Resend Email</button>
					</div>
					<div class="col-sm-6">
						<button id="changeThatEmail" data-toggle="modal" data-target="#changeEmail" class="btn btn-success btn-sm btn-block">Change Email Address</button>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" id="sendAndChange" class="btn btn-success btn-sm" data-dismiss="modal">Change &amp; Send Email</button>
			</div>
		</div>
	</div>
</div>