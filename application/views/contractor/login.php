...
<div class="row">
	<div class="col-sm-5">
		<div class="well">
		<?php 
			echo form_open('contractors/check-login');
	...
	<div class='col-sm-7'>
		...
		<a href="<?php echo base_url(); ?>contractors/forgot-password" class="btn btn-success pull-left btn-sm">
			<i class="fa fa-lock"></i> Forgot Password?
		</a>
		<a href="<?php echo base_url(); ?>contractors/create-account" class="btn btn-success pull-right btn-sm">
