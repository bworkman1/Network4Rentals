<h2><i class="text-success fa fa-unlock"></i> Forgot Password</h2>
...
<div class="row">
	<div class="col-sm-5">
    	<div class="well">
			<?php
                echo form_open('contractors/forgot-password');
				...
				echo '<br>';
				echo '<button type="submit" class="btn btn-success btn-sm"><i class="fa fa-location-arrow"></i> Reset</button>';
				echo form_close();
			?>
		</div>
	</div>
