...
<div class="panel panel-success">
	...
	<div class="panel-body">
		...
		<div class="row">
			<div class="col-sm-8">
				<p>Proper setup of this page will allow you an online marketing presence that can highligh your entire company or be directed specifically to the home rental market. Landlords will use this public page to research potential contractors.</p>
			</div>
			<div class="col-sm-4 text-right">
				<?php
					if($settings->active == 'y') {
						if($link == true) {
							echo '<a href="http://n4r.rentals/'.strtolower(str_replace(' ', '-', $settings->unique_name)).'" class="btn btn-success btn-lg" target="_blank">
