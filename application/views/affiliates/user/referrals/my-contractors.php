    ...
    <div class="widget-body">
        ...
        <?php if(!empty($affiliates)) {  ?>
            ...
            <table class="table table-hover no-margin">
                ...
                foreach ($affiliates as $row) {
                    ...
                    echo '</td>';
                    echo '<td><a href="'.base_url('affiliates/my-referrals/contractors/'.$row->id).'"
        ...
        <?php } else { ?>
            <div class="alert alert-info">
                <h3>You have not signed up any Contractors yet</h3>
                <p>Once a renter creates an account with your affiliate id attached to it, you will see them
                    show up here.</p>
