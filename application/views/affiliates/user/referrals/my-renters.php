    ...
    <div class="widget-body">
                ...
                <tbody>
                    ...
                    foreach ($affiliates as $row) {
                        echo '<tr>';
                            ...
                            echo '<td>'.$row->zip.'</td>';
                            echo '<td>('.substr($row->phone, 0, 3) .') '.
                                substr($row->phone, 3, 3) .'-'.
                                substr($row->phone, 6).'</td>';
                         echo '</tr>';
                    }
                    ?>
                </tbody>
        ...
        <?php } else { ?>
            <div class="alert alert-info">
                <h3>You have not signed up any Renters yet</h3>
                <p>Once a renter creates an account with your affiliate id
                    attached to it, you will see them show up here.</p>
