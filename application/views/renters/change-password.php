<h2><i class="fa fa-unlock text-warning"></i> </i>Change Your Password Below</h2>
...
<div class="row">
	<div class="col-sm-6">
		<div class="well">
			<?php 
				echo form_open('renters/reset_password');
				...
				echo '<button type="submit" class="btn btn-warning btn-sm"><i class="fa fa-location-arrow"></i> Change Password</button>';
				echo form_close(); ?>
		</div>
	</div>
	<div class="col-sm-6">
		...
		<a href="<?php echo base_url(); ?>renters/login" class="btn btn-warning btn-sm"><i class="fa fa-unlock"></i> Login</a>
		<hr>
		...
		<a href="https://network4rentals.com/faqs/" class="btn btn-warning btn-sm"><i class="fa fa-question"></i> View FAQs</a>
	</div>
</div>