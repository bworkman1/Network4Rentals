...
<div class="panel panel-warning">
	<div class="panel-heading">
		<div class="row">
			<div class="col-sm-10">
				<i class="fa fa-plus"></i> Add Past Landlord
			</div>
			<div class="col-sm-2">
	...
	<div class="panel-body">
		...
		<hr>
		<h4>Step 1 Search For Your Landlord</h4>
		<p>Search For Your Landlord By Name Or Business To Auto Fill Input</p>
		<div class="row">
			<div class="col-sm-5">
				<input type="text" class="form-control" id="landlord-search" placeholder="Start Typing To Search 3 Characters Min">
				<div id="results">
				</div>
			</div>
			<div class="col-sm-7">
...
<div id="addLandlord"> 
<?php
	echo form_open_multipart('renters/add-past-landlord');

	echo '<div class="row">';
		echo '<div class="col-sm-6">';
			echo '<label>Email:</label>';
			echo '<input type="email" class="form-control" maxlength="100" id="email" name="landlord_email">';
		echo '</div>';
		echo '<div class="col-sm-6">';
			echo '<label>Cell Phone:</label>';
	...
	echo form_label('<i class="fa fa-asterisk text-danger"></i> Landlords/Contact Name:');
	$data = array(
	  'name'        => 'landlord_name',
	  'id'          => 'lName',
	  'maxlength'   => '200',
	...
	echo '</div>';
	echo '<div class="col-sm-6">';
	echo form_label('<i class="fa fa-asterisk text-danger"></i> Move Out Date:');
	$data = array(
	  'name'        => 'move_out',
	  'id'          => 'move_out',
	  'maxlength'   => '60',
	...
	echo '<br><button class="btn btn-primary btn-sm saveLandlord" type="submit"><i class="fa fa-save"></i> Add Landlord</button>';
	echo form_close();
?>
</div>
</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div align="center" class="embed-responsive embed-responsive-16by9">
					<iframe width="560" height="315" src="//www.youtube.com/embed/Z-oKJi1naqY" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-warning btn-sm" data-dismiss="modal">Close</button>
