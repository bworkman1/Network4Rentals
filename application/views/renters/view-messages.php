...
<div class="panel panel-warning">
		...
		<div class="row">
			...
			<div class="col-sm-2">
				<?php if($this->session->userdata('date_to_msg')) { ?>
					<a href="<?php echo base_url().'renters/reset-dates-msg/'.(int)$this->uri->segment(3); ?>" class="btn btn-xs btn-warning btn-block"><i class="fa fa-times"></i> Reset Dates</a>
				<?php } ?>
			</div>
			<div class="col-sm-3">
	...
	<div class="panel-body">
		<?php echo form_open_multipart('renters/send_new_message/'.(int)$this->uri->segment(3)); ?>
