...
<div class="panel panel-warning">
	<div class="panel-heading">
		<div class="row">
			<div class="col-sm-4">
				<i class="fa fa-comments"></i> Send New Message
			</div>
			<div class="col-sm-2">
				<?php if($this->session->userdata('date_to_msg')) { ?>
					<a href="<?php echo base_url().'renters/reset-dates-msg/'.(int)$this->uri->segment(3); ?>" class="btn btn-danger btn-block"><i class="fa fa-times"></i> Reset Dates</a>
				<?php } ?>
			</div>
			<div class="col-sm-3">
				<button class="btn btn-primary btn-block" data-toggle="modal" data-target="#searchMessages"><i class="fa fa-search"></i> Search Dates</button>
			</div>
			<div class="col-sm-3">
				<a href="<?php echo base_url().'renters/print_messages/'.(int)$this->uri->segment(3); ?>" class="btn btn-primary btn-block"><i class="fa fa-print"></i> Print Messages</a>
			</div>
		</div>
	</div>
	<div class="panel-body">
		<?php echo form_open_multipart('renters/send_new_messages/'.(int)$this->uri->segment(3)); ?>
			<?php
				echo '<p><b>Landlord:</b> '.$message_to['name'].'</p>';
			?>
			<textarea class="form-control" name="message" style="min-height: 150px"></textarea>
			<br>
			<div class="row">
				<div class="col-sm-6">
...
<div class="modal fade" id="searchMessages" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
		<?php echo form_open('renters/view-messages/'.(int)$this->uri->segment(3)); ?>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-warning btn-sm"><i class="fa fa-search"></i> Search</button>
      </div>
	  <?php echo form_close(); ?>
    </div>
  </div>
