<h2 class="text-warning">Forgot Password</h2>
...
<div class="row">
	<div class="col-sm-5">
    	<div class="well">
			<?php
                echo form_open('renters/forgot_password');
                ...
                echo form_input($data);
				echo '<span class="text-danger"><b>Tip:</b> Not case sensitive</span>';
				echo '<div class="spacing15"></div>';
				echo '<button type="submit" class="btn btn-warning btn-sm"><i class="fa fa-location-arrow"></i> Reset</button>';
				echo form_close();
			?>
		</div>
	</div>
