...
<?php echo form_open('advertisers/create-account-not-present', array('id'=>'createAccountForm')); ?>
		...
		<div class="col-md-12 well text-left">
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="row">
						<div class="col-xs-1">
							<input type="checkbox" checked id="termsService" <?php echo set_checkbox('terms', 'y'); ?> required="required" value="y" name="terms" class="fade" tabindex="19">
						</div>
