...
<div class="tab-content">
	<div class="tab-pane fade in active" id="profile">
		...
		<hr>
		<?php echo form_open('advertisers/update-personal-info'); ?>
	...
	<div class="tab-pane fade" id="password">
		...
		<hr>
		<?php echo form_open('advertisers/update-password'); ?>
			<div class="row">
				<div class="col-sm-6">
	...
	<div class="tab-pane fade" id="subscription">
		<div class="row">
			...
			<div class="col-sm-6 text-right">
				<?php if($subscription==false) { ?>
					<a href="<?php echo base_url(); ?>contractors/add-zip-codes" style="margin-top: 5px" class="btn btn-primary btn-sm"><i class="fa fa-map-marker"></i> Add Zips/Services</a>
				<?php } ?>
			</div>
		</div>
		<hr>
		<?php	
			if($subscription==false) {
				...
				echo '<div class="well">';
					echo '<i class="fa fa-bullhorn fa-fw text-primary"></i> Currently You Subscribe To <b>'.count($subscription).'</b> Zip Codes<br>';
					echo '<i class="fa fa-dollar fa-fw text-primary"></i> For A Total Of <b>$'.$payment->amount.'</b> Every <b>'.$payment->payment_frequency.'</b> Month(s)<br>';
					...
					echo '<i class="fa fa-calendar fa-fw text-primary"></i> Next Billing Date: <b>'.date('m-d-Y', $next_due_date).'</b><br>';
					echo '<i class="fa fa-credit-card fa-fw text-primary"></i> Credit Card: <b>****-****-****-'.$payment->last_4.'</b> <small> | Expires On </small>'.date('m-Y', strtotime($payment->expires));
				...
				echo '</div>';
				echo '<h4><i class="fa fa-bars text-primary"></i> The Break Down</h4>';
				echo '<hr>';
				...
				foreach($subscription as $key => $val) {
					echo '<div class="row">';
						...
						echo '</div>';
						echo '<div class="col-sm-2">';
							echo '<a href="'.base_url().'advertisers/edit-post/'.$val->id.'" class="btn btn-block btn-primary btn-sm">View Post</a>';
						echo '</div>';
					echo '</div>';
					echo '<br>';
				}
