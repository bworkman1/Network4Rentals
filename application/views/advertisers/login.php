...
<?php
	...
	{
		echo '<div class="alert alert-danger"><h4 class="pull-left">Error: </h4> '.$this->session->flashdata('error').'.</div>';
	}
...
<div class="row">
	<div class="col-sm-5">
		<div class="well">
		<?php 
			echo form_open('advertisers/check-login');
	...
	<div class='col-sm-7'>
		...
		<a href="<?php echo base_url(); ?>advertisers/forgot-password" class="btn btn-primary pull-left btn-sm">
			<i class="fa fa-lock"></i> Forgot Password?
		</a>
		<a href="<?php echo base_url(); ?>advertisers/create-account" class="btn btn-primary pull-right btn-sm">
