...
<table width="100%">
	<tr>
		<td width="50%"><h3>User Submitted Service Request</h3></td>
		<td width="50%" align="right"><p><em><b>Printed On:</b> <?php echo date('m-d-Y'); ?></em></p></td>
	</tr>	
	<tr>
		<td><h3><b>Service Requested:</b></h3><hr></td>
		<td><h3><b>Contact Info:</b></h3><hr></td>
	</tr>
	<tr>
		<td>
			<table>
		...
		<td>
			<table cellpadding="0">
				...
				<tr>
					...
					<td><?php echo $details->schedule_phone; ?></td>
				</tr>			
				<tr>
				...
				<tr>
					<td align="right" valign="top"><b>Submitted On:</b> </td>
					<td>
						<?php 
							if($details->completed != '0000-00-00 00:00:00') {
								echo date('m-d-y h:m a', strtotime($details->submitted, +3600)). '<small>EST</small>'; 
							} else {
								echo 'N/A'; 
							}
						?>
				...
				<tr>
					...
					<td>
						<?php 
							if($details->completed != '0000-00-00 00:00:00') {
								echo date('m-d-y h:m a', strtotime($details->completed, +3600)). '<small>EST</small>'; 
							} else {
								echo 'N/A'; 
							}
						?>
