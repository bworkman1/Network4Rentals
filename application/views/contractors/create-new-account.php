<div class="row">
	...
	<div class="col-md-3 hidden-sm hidden-xs">
		<?php if (!empty($affliate)) { ?>
			<div class="panel panel-warning">
				<div class="panel-heading">
					<h4 style="color: #fff !important">Your Local Partner</h4>
				</div>
				<div style="padding: 10px">
					<p>I am here to help or answer any questions you have.</p>
					<p><b><?php echo $affliate->first_name.' '.$affliate->last_name; ?> </b><br><small>N4R Partner</small></p>
		...
		<div class="panel panel-blue">
			<div class="panel-heading">
				<h4 style="color: #fff !important">Why?</h4>
			</div>
			<div class="panel-body">
				<ol id="benefits">
					<li><i class="fa fa-check-circle-o fa-lg"></i> Website</li>
					<li><i class="fa fa-check-circle-o fa-lg"></i> Listed On Service Request</li>
