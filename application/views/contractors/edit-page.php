<?php 
	echo form_open('contractor/edit-page/'.$details->id); 
?>
		<?php
			if(!empty($errors)) {
			...
			<div class="panel-body">
				...
				<?php
					if($this->session->flashdata('error')) {
						echo '<div class="alert alert-danger"><p><b>Error:</b> '.$this->session->flashdata('error').'</p></div>';
					}
					if($this->session->flashdata('success')) {
						echo '<div class="alert alert-success"><p><b>Success:</b> '.$this->session->flashdata('success').'</p></div>';
					}
				?>
				...
				<div class="row">
					...
					<div class="col-md-2">
						<br>
						<button type="submit" class="btn btn-block btn-success savePost"><i class="fa fa-save"></i> Save <?php echo end($pageArray); ?></button>
					</div>
					<div class="col-md-2">
						<br>
						<a href="<?php echo base_url('contractor/delete-page/'.$details->id); ?>" class="btn 	btn-block btn-danger"><i class="fa fa-times"></i> Delete Page </a>
					</div>
